...
# Results:
    ...
    # Adjusted R2 went up
    # All else equal, the cost of being
    #     a smoker increases by $23812.57
    # All else equal, the cost of being 
    #     a male is $267.17 lower than being a female
...
# Results:
    ...
    # TASK-> Forecast the medical expensees for a 40 yr old
    #   female non-obese smoker with no children
