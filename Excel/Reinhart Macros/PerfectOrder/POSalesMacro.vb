...
'Create the Sales Table and name it sales
    Range(Selection, Selection.End(xlToRight)).Select
    Range(Selection, Selection.End(xlDown)).Select
    ActiveSheet.ListObjects.Add(xlSrcRange, Range("$A$1:$AB$41012"), , xlYes).Name _
        = "Table1"
...
'Copy the customer information to sheet 1 and name it customers
    ...
    Range(Selection, Selection.End(xlToRight)).Select
    Range(Selection, Selection.End(xlDown)).Select
    ActiveSheet.ListObjects.Add(xlSrcRange, Range("$A$1:$G$41012"), , xlYes).Name _
        = "Table2"
...
'Back to the customer tab to format and add the full address
    ...
    Range("Customer[[#Headers],[Customer '#]]").Select
    Range("H1").Select
...
'Back to the Results page
    Sheets("Results").Select
    Columns("E:H").Select
    Range("Sales[[#Headers],[Corp Manuf '#]]").Activate
    Range("A2").Select
